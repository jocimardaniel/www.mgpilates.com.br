(function($) {"use strict";
	...
	$(document).ready(function($) {
		...
		$("#main-color li").bind('click', function() {
			...
			$('<link rel="stylesheet" id="change-color" type="text/css" href="css/colors/' + ( color_name ) + '.css?' + ( Math.random(0, 100)) + '" >')
   				.appendTo("head");
		...
		$("#main-slider").change(function(e){
			...
			var that = $(this),
				...
				if( new_slide != "" ){
					new_url = new_url + "/" + new_slide + '.html';
				}
